...
zoho_data/
  api/
    resources/      # SDK resource files (e.g., apis.json)
  tokens/
    token_store.txt # Stores OAuth tokens
logs/
  sdk.log           # SDK operational logs
output/
  *.txt             # Output files from CLI commands
src/
  __init__.py
